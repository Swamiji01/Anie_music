...
async def thumb(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open("driver/storage/<pending>") #Todo
    ...
    font = ImageFont.truetype("driver/storage/regular.ttf", 50)
    font2 = ImageFont.truetype("driver/storage/medium.ttf", 72)
    draw.text(
        (25, 615),
        f"{title[:20]}...",
        fill="black",
